...
export async function instantiate(imports={}, runInitializer=true) {
    ...
    const js_code = {
        ...
        'com.jarbas.retroarkanoid.jsSpeech_$external_fun' : (p0) => speak(p0),
        'com.jarbas.retroarkanoid.jsPlaySound_$external_fun' : (p0) => playSound(p0)
    }
    ...
    const wasmFilePath = './retroarkanoid.wasm';
    const importObject = {
        js_code,
